...
void main() {
  testWidgets('Test for Sign-up text on scaffold appbar',
  ...
  testWidgets('Test for all text on SignupPage and font',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: SignupPage()));
    await tester.pump();
    Text font = tester.firstWidget(find.text('Create your account'));
    expect(find.text('Create your account'), findsOneWidget);
    expect(find.text('It\'s free and hardly takes more than a minute'),
        findsOneWidget);
