...
class GetBikePointNumberOfBikesViewTestCase(APITestCase):

    def setUp(self):
        self.bikepoint_id = 'BikePoints_1'
        self.url = reverse('number_of_bikes', kwargs = {'bikepoint_id': self.bikepoint_id})
    ...
    def test_response_is_not_none(self):
        self.assertFalse(self.response.data['Number of bikes'] == None)
