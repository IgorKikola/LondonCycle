...
class GetClosestBikePointWithAtLeastNBikesViewTestCase(APITestCase):
    ...
    """ Tests of the get_closest_bikepoint_with_at_least_n_bikes view """

    def test_get_url(self):
        self.assertEqual(self.url, f'/closest/bikepoint/with/{self.n}/bikes/from/{self.lat}/{self.lon}/')
    ...
    def __get_url(self, lat, lon, n):
        return reverse('get_closest_bikepoint_with_at_least_n_bikes',
                        kwargs = {'lat': lat,
                                  'lon': lon,
                                  'n': n})
